...
export default function AllUser() {
  ...
  const filteredUsers = users.filter((user) => {
    ...
    const matchesSearch =
      ...
      user.userGamePlayName?.toLowerCase().includes(keyword);
      ...
      >
        <div className="flex flex-col sm:flex-row gap-4 flex-1">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              type="text"
              placeholder="Search by username or game play name..."
              value={searchTerm}
              onChange={(e) => {
            ...
            <tbody>
              {currentItems.map((user, idx) => (
                ...
                >
                  ...
                  <td className="px-7 py-5 text-gray-200 text-base font-mono">
